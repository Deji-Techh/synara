...
export const TunnelPreviewStatusSchema = z.object({
  ...
  url: z.string().url(),
  expiresAt: z.string(),
  state: TunnelPreviewStateSchema,
  errorMessage: z.string().nullable(),
});
...
export const RestoreReviewedFileParamsSchema = ReadAppFileParamsSchema.extend({
  // null means the file was added by the session and should be removed.
...
export const UpdateAppIdentityParamsSchema = z.object({
...
export const UpdateAppIdentityResultSchema = z.object({
...
export const appContracts = {
  ...
  startTunnelPreview: defineContract({
    channel: "app:start-tunnel-preview",
    input: AppIdParamsSchema,
    output: TunnelPreviewStatusSchema,
  }),

  getTunnelPreviewStatus: defineContract({
    channel: "app:get-tunnel-preview-status",
    input: AppIdParamsSchema,
    output: TunnelPreviewStatusSchema.nullable(),
  }),

  stopTunnelPreview: defineContract({
    channel: "app:stop-tunnel-preview",
    input: AppIdParamsSchema,
    output: z.void(),
  }),
  ...
  restoreReviewedFile: defineContract({
    channel: "app:restore-reviewed-file",
    input: RestoreReviewedFileParamsSchema,
    output: z.void(),
  }),
  ...
  getAppIdentity: defineContract({
    channel: "app:get-identity",
    input: AppIdParamsSchema,
    output: AppIdentitySchema,
  }),

  updateAppIdentity: defineContract({
    channel: "app:update-identity",
    input: UpdateAppIdentityParamsSchema,
    output: UpdateAppIdentityResultSchema,
  }),
