...
export async function startTunnelPreview(_appId: number): Promise<TunnelPreviewStatus> {
...
export async function getTunnelPreviewStatus(_appId: number): Promise<TunnelPreviewStatus | null> {
  return null;
}
