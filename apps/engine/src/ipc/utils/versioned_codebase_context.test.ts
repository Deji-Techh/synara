...
describe("parseFilesFromMessage", () => {
  describe("caide-read tags", () => {
    it("should parse a single caide-read tag", () => {
      const input = '<caide-read path="src/components/Button.tsx"></caide-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    });

    it("should parse multiple caide-read tags", () => {
      const input = `
        <caide-read path="src/components/Button.tsx"></caide-read>
        <caide-read path="src/utils/helpers.ts"></caide-read>
        <caide-read path="src/styles/main.css"></caide-read>
      `;
      const result = parseFilesFromMessage(input);
    ...
    it("should trim whitespace from file paths in caide-read tags", () => {
      const input = '<caide-read path="  src/components/Button.tsx  "></caide-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    });
    ...
    it("should handle file paths with special characters", () => {
      const input = '<caide-read path="src/components/@special/Button-v2.tsx"></caide-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/@special/Button-v2.tsx"]);
    });
  });

  describe("caide-code-search-result tags", () => {
    it("should parse a single file from caide-code-search-result", () => {
      const input = `<caide-code-search-result>
src/components/Button.tsx
</caide-code-search-result>`;
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    });

    it("should parse multiple files from caide-code-search-result", () => {
      const input = `<caide-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should skip empty lines in caide-code-search-result", () => {
      const input = `<caide-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should handle multiple caide-code-search-result tags", () => {
      const input = `<caide-code-search-result>
src/components/Button.tsx
src/components/Input.tsx
</caide-code-search-result>
...
src/styles/main.css
  ...
  describe("mixed tags", () => {
    it("should parse both caide-read and caide-code-search-result tags", () => {
      const input = `
<caide-read path="src/config/app.ts"></caide-read>
...
<caide-read path="src/components/Header.tsx"></caide-read>
...
<caide-read path="src/config/site.ts"></caide-read>
...
`;
    ...
    it("should handle nested angle brackets in file paths", () => {
      const input = '<caide-read path="src/components/Generic<T>.tsx"></caide-read>';
      const result = parseFilesFromMessage(input);
...
SRC/COMPONENTS/BUTTON.TSX
    ...
    it("should handle very long file paths", () => {
      ...
      const input = `<caide-read path="${longPath}"></caide-read>`;
      const result = parseFilesFromMessage(input);
...
describe("processChatMessagesWithVersionedFiles", () => {
  ...
  describe("processing assistant messages", () => {
    it("should process assistant messages with sourceCommitHash", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'I found this file: <caide-read path="src/old.ts"></caide-read>',
          providerOptions: {
            "caide-engine": {
      ...
      const chatMessages: ModelMessage[] = [
        {
          ...
          content: [
            {
              type: "text",
              text: 'Here is the file: <caide-read path="src/array.ts"></caide-read>',
            },
            {
              type: "text",
    ...
    it("should skip user messages", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "user",
          content: 'Check this: <caide-read path="src/user-file.ts"></caide-read>',
        },
      ];
      const appPath = "/test/app";
    ...
    it("should skip assistant messages without sourceCommitHash", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'File here: <caide-read path="src/no-commit.ts"></caide-read>',
          // No providerOptions
        },
        {
          role: "assistant",
          content: 'Another file: <caide-read path="src/no-commit2.ts"></caide-read>',
          providerOptions: {
            // caide-engine not set
          },
        },
      ];
      const appPath = "/test/app";
  ...
  describe("parsing multiple file paths", () => {
    it("should process multiple files from caide-code-search-result", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `<caide-code-search-result>
src/file1.ts
src/file2.ts
</caide-code-search-result>`,
          providerOptions: {
    ...
    it("should process mixed caide-read and caide-code-search-result tags", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `
<caide-read path="src/file1.ts"></caide-read>
  ...
  describe("error handling", () => {
    it("should handle file not found (returns null)", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Missing file: <caide-read path="src/missing.ts"></caide-read>',
          providerOptions: {
            "caide-engine": {
              sourceCommitHash: "commit1",
            },
    ...
    it("should handle getFileAtCommit throwing an error", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Error file: <caide-read path="src/error.ts"></caide-read>',
          providerOptions: {
            "caide-engine": {
              sourceCommitHash: "commit1",
            },
  ...
  describe("multiple messages", () => {
    it("should process multiple messages with different commits", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        ...
        {
          role: "assistant",
          content: 'Here it is: <caide-read path="src/file1.ts"></caide-read>',
          providerOptions: {
            "caide-engine": {
              sourceCommitHash: "commit1",
            },
        ...
        {
          role: "assistant",
          content: 'Here it is again: <caide-read path="src/file1.ts"></caide-read>',
          providerOptions: {
            "caide-engine": {
  ...
  describe("integration with files parameter", () => {
    it("should combine files parameter with versioned files from messages", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Old version: <caide-read path="src/old.ts"></caide-read>',
          providerOptions: {
            "caide-engine": {
              sourceCommitHash: "abc123",
            },
