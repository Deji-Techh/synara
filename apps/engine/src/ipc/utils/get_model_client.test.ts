...
describe("getModelClient", () => {
  ...
  test("keeps the Anthropic gateway prefix for Caide Engine models", async () => {
  ...
  test("keeps the Anthropic gateway prefix for Caide Engine auto-mode fallback models", async () => {
    const { modelClient } = await getModelClient(
      {
        provider: "auto",
        name: "auto",
  ...
  test("routes Caide Free through its dedicated engine model", async () => {
    const { modelClient } = await getModelClient(
      {
        provider: "auto",
        name: "free-pro",
