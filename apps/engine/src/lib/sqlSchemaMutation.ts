...
export function getSqlSchemaMutationAnalysis(sql: string): SqlSchemaMutationAnalysis {
...
export function getSqlDataDeletionAnalysis(sql: string): SqlDataDeletionAnalysis {
