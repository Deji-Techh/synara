...
// Token refresh service. CAIDE currently reuses the hosted Neon OAuth helper
// endpoint; swap this constant if/when a first-party host exists.
const NEON_TOKEN_REFRESH_URL = "https://oauth.dyad.sh/api/integrations/neon/refresh";
