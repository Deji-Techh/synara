...
function Component() {
  return <img src="/images/old.png" alt="Photo" />;
    ...
    const changes = new Map([[3, { classes: [], prefixes: [], imageSrc: "/images/new.png" }]]);
...
function Component() {
  return <img alt="Photo" />;
    ...
    const changes = new Map([[3, { classes: [], prefixes: [], imageSrc: "/images/added.png" }]]);
...
function Component() {
  return <div><img src="/old.png" alt="Old" /></div>;
    ...
    const changes = new Map([[3, { classes: [], prefixes: [], imageSrc: "/new.png" }]]);
