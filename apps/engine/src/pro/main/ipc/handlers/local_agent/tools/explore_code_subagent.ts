...
import { runSubagentLoop } from "./subagent_runner";
...
export async function runExploreCodeSubagent({
  ...
  const maxOutputTokens = SUBAGENT_MAX_OUTPUT_TOKENS;
  ...
  // spend an extra Caide Engine step feeding the "Report accepted." tool result
