            ...
            <CaideStaggerGroup>
              <CaideStack gap="3">
                ...
                <CaideStaggerItem index={1}>
                  <h1 className="text-3xl font-bold tracking-[-0.03em]">Build the first screen</h1>
                </CaideStaggerItem>
                <CaideStaggerItem index={2}>
                  <p className="max-w-[60ch] text-base leading-7 text-[var(--caide-text-secondary)]">
                    Describe the product, primary user, core workflow, platform, visual direction,
                    and motion character. CAIDE will approve the design and motion specifications
