...
exports.isExploreCodeSubagentPrompt = isExploreCodeSubagentPrompt;
exports.buildExploreCodeNestedToolArgs = buildExploreCodeNestedToolArgs;
exports.buildExploreCodeSubmitReportArgs = buildExploreCodeSubmitReportArgs;
exports.buildExploreCodeSubagentReport = buildExploreCodeSubagentReport;
function isExploreCodeSubagentPrompt(text) {
    return (text.includes("User query:") &&
        text.includes("App component render flow") &&
        text.includes("Intent:"));
}
function buildExploreCodeNestedToolArgs() {
    return {
...
function buildExploreCodeSubmitReportArgs() {
    return {
...
function buildExploreCodeSubagentReport() {
    return [
        "## explore_code report",
        "",
        'Query: "App component render flow"',
        ...
        JSON.stringify({
            ...
            recommendedPrimaryAction: {
                ...
                reason: "The report has enough high-confidence findings for an answer-only investigation.",
            },
        }, null, 2),
        "```",
        "",
