...
// A provider whose latest version Caide cannot look up (self-updating CLIs such as
...
// Header affordance: reserved for providers Caide can actually assert are outdated.
