...
/**
 * Spaces organize ordinary projects only: the Chats container is reachable from every
 * Space and so belongs to none. This is the membership rule the whole feature
