...
import type { OrchestrationReadModel } from "@caide/contracts";
...
// other providers can opt into their own kind set.
...
// Shared machinery behind the hidden-container candidate helpers used by home-chat
