...
// Purpose: Detects when a normal chat prompt is actually asking Caide to create an automation.
...
import { completionPolicyFromStopWhen } from "@caide/shared/automationCompletionPolicy";
