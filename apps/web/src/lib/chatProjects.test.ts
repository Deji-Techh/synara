...
import { ProjectId, type OrchestrationShellSnapshot } from "@caide/contracts";
...
describe("isHomeChatContainerProject", () => {
  it("matches the managed Documents/Caide general-chat root used by older drafts", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Caide",
          kind: "chat",
          name: "Home",
          remoteName: "Home",
        },
  ...
  it("matches Codex-style date/slug chat workspaces under Documents/Caide", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Caide/2026-06-11/yes-it-takes-all-the-skills",
          kind: "chat",
          name: "Yes it takes",
  ...
  it("trusts the chat kind before any server workspace path resolves", () => {
    ...
    // so chat rows aren't mis-partitioned during startup.
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Caide/2026-06-11/some-chat",
          kind: "chat",
          name: "Some chat",
  ...
  it("does not classify ordinary projects under Documents/Caide as home chat containers", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Caide",
