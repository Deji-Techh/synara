...
describe("parseBareComposerLink", () => {
  it("returns the URL when the whole text is one bare link", () => {
    expect(parseBareComposerLink("https://github.com/Emanuele-web04/caide")).toBe(
      "https://github.com/Emanuele-web04/caide",
    );
  });
...
describe("describeLinkChip", () => {
  it("shortens GitHub pull request URLs to owner/repo#number", () => {
    expect(describeLinkChip("https://github.com/Emanuele-web04/caide/pull/155")).toEqual({
      label: "Emanuele-web04/caide#155",
      isGitHub: true,
    });
  });
