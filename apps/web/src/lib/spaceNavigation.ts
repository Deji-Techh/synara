...
import type { ProjectId, SpaceId, ThreadId } from "@caide/contracts";
...
/**
 * Whether a Space may land on a thread in this project. The Chats container belongs to no
 * Space and is reachable from every one of them; any other thread belongs to exactly its
