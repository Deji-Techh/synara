...
export const serverQueryKeys = {
  ...
  toolchainDoctor: () => ["server", "toolchainDoctor"] as const,
...
// through lsof/ps; active Caide-owned runs still poll for responsive status.
...
// UTC offset; all metrics are computed from Caide's local DB projections.
