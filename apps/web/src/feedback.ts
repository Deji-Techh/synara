...
// Depends on: The public trycaide feedback endpoint.
...
export const FEEDBACK_CATEGORIES = [
  ...
  { value: "performance", label: "Performance", lead: "Caide felt slow" },
...
const DEFAULT_FEEDBACK_ENDPOINT = "https://www.trycaide.com/api/feedback";
...
export function formatFeedbackSummary(input: {
  ...
  return [`${lead} in Caide ${diagnostics.appVersion}${usageContext}.`, "", ...detailLines].join(
    "\n",
  );
}
