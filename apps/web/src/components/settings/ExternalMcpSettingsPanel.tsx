      ...
      {setup && setupIntegration && setupPrompt && manualConfiguration && examplePrompt ? (
        <SettingsSection title={`Connect ${setupIntegration.name}`}>
          <SettingsRow
            ...
            description={
              revoked
                ? "This connection has been revoked and can no longer access Caide."
                : integrationExpired
                  ? "This connection has expired and can no longer access Caide."
                  : connected
                    ? "Caide received a request from this agent. Setup is complete."
                    : paired
                      ? "The private credential is stored locally. If the agent has not registered Caide yet, give it the setup prompt below."
                      : pairingExpired
          ...
          <SettingsRow
            ...
            status={
              connected
                ? "Connection verified by Caide."
                : "Caide will show Connected after the agent makes its first request."
            }
            control={
              <Button
                size="xs"
