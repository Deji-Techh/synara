...
const EDITOR_CHAT_PANE_STORAGE_KEY = "caide.editor.chatPaneWidth";
const EDITOR_SIDEBAR_VISIBLE_STORAGE_KEY = "caide.editor.sidebarVisible";
const EDITOR_CHAT_PANE_VISIBLE_STORAGE_KEY = "caide.editor.chatPaneVisible";
