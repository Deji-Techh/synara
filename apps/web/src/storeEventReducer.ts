...
} from "@caide/shared/pinnedMessages";
import { isPendingInteractionResponseClaimable } from "@caide/shared/pendingInteractions";
import {
  addThreadMarker,
  removeThreadMarker,
  setThreadMarkerDone,
  setThreadMarkerLabel,
} from "@caide/shared/threadMarkers";
...
type ReadModelThread = import("@caide/contracts").OrchestrationReadModel["threads"][number];
