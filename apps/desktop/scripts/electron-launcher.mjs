// This file mostly exists because we want dev mode to say "Caide (Dev)" instead of "electron"
...
import { resolveCaideDesktopFlavor, caideDesktopIdentity } from "@caide/shared/desktopIdentity";
...
const MICROPHONE_USAGE_DESCRIPTION =
  "Caide needs microphone access so you can record voice notes and transcribe them into the chat composer.";
