...
import { isBrowserCopyLinkChord } from "@caide/shared/browserShortcuts";
import {
...
export class DesktopBrowserManager {
  ...
  private scheduleWindowOpenTab(input: {
    ...
    // runtimes. Only the first decision may create a canonical Caide tab.
    if (
  ...
  attachWebview(input: BrowserAttachWebviewInput, hostWebContentsId: number): ThreadBrowserState {
    ...
    if (
      ...
      throw new Error("The browser webview does not belong to this Caide window and partition.");
    }
