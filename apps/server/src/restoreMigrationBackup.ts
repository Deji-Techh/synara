...
const USAGE = "Usage: caide-restore-migration-backup <absolute-database-path>";
const STOP_PROCESSES_WARNING =
  "WARNING: Stop every Caide process before restoring a migration backup.";
...
const entryPointNames = new Set([
  ...
  "caide-restore-migration-backup",
]);
