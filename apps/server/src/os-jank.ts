...
import { createCachedLoginShellPathReader } from "@caide/shared/loginShellEnvironment";
import {
  expandHomePath as expandHomePathSync,
  resolveCaideHomeDirectory,
} from "@caide/shared/caideHome";
...
export function fixPath(
  ...
  try {
    ...
    // Cached by default: the probe result is persisted under the Caide home and reused
...
export const resolveBaseDir = (raw: string | undefined): Effect.Effect<string> =>
  Effect.succeed(resolveCaideHomeDirectory({ configuredHome: raw }));
