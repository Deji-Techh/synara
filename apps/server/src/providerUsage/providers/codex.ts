...
import type { ServerProviderUsageLimit, ServerProviderUsageLine } from "@caide/contracts";
...
// The token was already redeemed (by the CLI, or another Caide process): the file likely holds
