...
import type { ProviderKind, ServerProviderUsageSnapshot } from "@caide/contracts";
...
export interface ProviderUsageContext {
  ...
  /** Claude CLI binary ((settings.providers as any).claudeAgent?.binaryPath); defaults to "anthropic". */
