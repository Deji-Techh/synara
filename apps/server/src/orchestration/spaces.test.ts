...
import { CommandId, ProjectId, SpaceId, type OrchestrationCommand } from "@caide/contracts";
...
describe("Spaces", () => {
  ...
  it("rejects filing a legacy Home chat container into a space", async () => {
    ...
    const workspacePaths = {
      homeDir: "/Users/dev",
      chatWorkspaceRoot: "/Users/dev/Documents/Caide/Chats",
    };
    let readModel = createEmptyReadModel(createdAt);
    ...
    ({ readModel } = await dispatch(readModel, {
      ...
      title: "Caide",
      workspaceRoot: "/Users/dev/code/caide",
      createdAt,
    }));
