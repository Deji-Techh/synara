import { ApprovalRequestId, CommandId, type OrchestrationEvent } from "@caide/contracts";
import {
  addPinnedMessage,
  removePinnedMessage,
...
import { isStalePendingRequestFailureDetail } from "@caide/shared/threadSummary";
