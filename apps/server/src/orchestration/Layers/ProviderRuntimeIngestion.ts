...
import { makeDrainableWorker, startDrainableWorkerProducers } from "@caide/shared/DrainableWorker";
...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.CAIDE_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
...
/**
 * Resolves persisted image tool records to their durable display paths. The
  ...
  const processRuntimeEvent = (event: ProviderRuntimeEvent) =>
    Effect.gen(function* () {
            ...
            if (!slot.admitted) {
              ...
              yield* orchestrationEngine.dispatch({
                ...
                activity: {
                  ...
                  summary: `Caide limited this provider turn to ${MAX_NATIVE_CHILDREN_PER_PARENT_TURN} visible native subagents.`,
                  payload: {
      ...
      if (assistantSnapshot !== undefined) {
        ...
        const bufferedOpt = yield* Cache.getOption(
