import { CommandId, type ProviderRuntimeEvent, type ThreadId } from "@caide/contracts";
...
const make = Effect.gen(function* () {
  ...
  const processProviderEvent = (event: ProviderRuntimeEvent) => {
    // Native subagent lifecycle events carry the parent Caide thread id and the child identity
