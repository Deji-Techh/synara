...
import type { ChatAttachment, ProviderKind, ThreadId } from "@caide/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("caide.providerAttachmentStoragePath");
