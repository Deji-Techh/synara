...
// Purpose: Bridges ACP form elicitation schemas to Caide's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Caide's composer.
