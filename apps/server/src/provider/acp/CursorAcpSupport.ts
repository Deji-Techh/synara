 ...
 */
import { type CursorModelOptions, type ProviderModelDescriptor } from "@caide/contracts";
import { formatModelDisplayName, parseCursorCliReasoningEffort } from "@caide/shared/model";
...
// Cursor exposes "auto" as a `default` model id over ACP; keep Caide's "auto"
