import type { ProviderUserInputAnswers, UserInputQuestion } from "@caide/contracts";
...
const CAIDE_PLAN_REVIEW_FEEDBACK =
...
/**
 * Caide owns the approval step after the planning turn settles. Returning a
...
export function makeGrokExitPlanModeCapturedResponse(): {
  ...
  return {
    outcome: "cancelled",
    feedback: CAIDE_PLAN_REVIEW_FEEDBACK,
  };
}

/** Caide has already received an implementation turn, so Grok may leave its native gate. */
