...
export interface AcpSessionRuntimeOptions {
   ...
   * `mcpCapabilities` (e.g. HTTP vs stdio for the Caide agent gateway).
   */
...
/**
 * Bridges Effect's child-process exit signal into Caide's process-tree proof. This is deliberately
...
>()("caide/provider/acp/AcpSessionRuntime") {
  static layer(
