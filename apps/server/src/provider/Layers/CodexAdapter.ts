...
import { caideSkillsDir } from "../skillsCatalog.ts";
...
// Generous by design; override with CAIDE_CODEX_TURN_IDLE_TIMEOUT_MS.
const CODEX_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "CAIDE_CODEX_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 900_000,
});
      ...
      Effect.gen(function* () {
        ...
        return (
          ...
          new CodexAppServerManager(services, {
            caideSkillsDir: caideSkillsDir(serverConfig.baseDir),
