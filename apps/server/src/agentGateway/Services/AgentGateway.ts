/**
 * AgentGateway - Caide app-control tool surface for provider agents.
 *
 * Serves the `caide_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Caide itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "caide/agentGateway/Services/AgentGateway",
) {}
