...
const productArchetypes = `# Product Archetype Decision Matrix
...
`;
const designSystem = `# Design-System Architecture Reference
...
`;
const componentContracts = `# Component Contracts Reference
...
`;
const accessibility = `# Accessibility Reference
...
`;
const antiSlop = `# Anti-Slop and Distinctiveness Reference
...
`;
const designToCode = `# Design-to-Code Reference
...
`;
const platformPatterns = `# Platform and Responsive Patterns Reference
...
`;
const qualityRubric = `# Expanded UI/UX Quality Rubric
...
`;
const motionDirection = `# Motion Direction and Capability Routing
...
`;
const screenSpec = `# Screen Specification Template
...
`;
const componentContract = `# Component Contract Template
...
- [ ]
`;
const designAudit = `# UI/UX Design Audit Template
...
Rationale:
`;
const designSpec = `# \`.caide/design-spec.json\` template
...
fixes.
`;
const motionStoryboard = `# Persistent Motion Storyboard
