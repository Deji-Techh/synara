...
} from "@caide/shared/browserAutomationCatalogue";
import { makeBrowserAutomationError } from "@caide/shared/browserAutomationErrors";
import { encodeBrowserMcpToolError } from "@caide/shared/browserAutomationMcpError";
...
function withGatewayIdempotencyKey(
  ...
  return {
    ...argumentsValue,
    idempotencyKey: `caide-mcp-${digest.slice(0, 40)}`,
  };
}
