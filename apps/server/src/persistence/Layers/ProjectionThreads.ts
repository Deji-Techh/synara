    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.engineChatId ?? null},
          ${row.initialCommitHash ?? null},
          ${row.chatMode ?? null},
          ${row.runtimeMode},
          ${row.interactionMode},
          ${row.envMode},
        ...
        DO UPDATE SET
          ...
          engine_chat_id = excluded.engine_chat_id,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          engine_chat_id AS "engineChatId",
          initial_commit_hash AS "initialCommitHash",
          chat_mode AS "chatMode",
