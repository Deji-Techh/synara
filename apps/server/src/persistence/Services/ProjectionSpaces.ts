...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@caide/contracts";
...
>()("caide/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}
