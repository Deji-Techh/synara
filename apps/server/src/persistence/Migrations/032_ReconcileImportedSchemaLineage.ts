 ...
 * names. Because the migrator skips by ID, Caide migrations 17-31 never run
 ...
 * Caide migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Caide installs (every column already
