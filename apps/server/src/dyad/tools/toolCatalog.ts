...
export type CaideMapping = "caide-native" | "needs-backend" | "missing" | "out-of-scope";
...
export const TOOL_CATALOG: readonly ToolMeta[] = [
  ...
  },
  {
    ...
    readOnly: false,
    caideMapping: "caide-native",
    caideTool: "dyad/db (bun:sql postgres)",
  },
  // read-search
  {
    name: "read_file",
  ...
  },
  {
    ...
    readOnly: true,
    caideMapping: "caide-native",
    caideTool: "dyad/web (local scorer)",
  },
  {
    name: "explore_code",
    category: "read-search",
    ...
    readOnly: true,
    caideMapping: "caide-native",
    caideTool: "dyad/web (digest + runner seam)",
  },
  {
    ...
    readOnly: true,
    caideMapping: "caide-native",
    caideTool: "dyad/web (mtime symbol index)",
  },
  // db-infra
  {
  ...
  },
  {
    ...
    readOnly: false,
    caideMapping: "caide-native",
    caideTool: "dyad/db (ordering + guidance)",
  },
  {
    name: "read_logs",
    category: "read-search",
  ...
  // web-media
  {
    ...
    readOnly: true,
    caideMapping: "caide-native",
    caideTool: "dyad/web (DDG default, keyed override M3)",
  },
  {
    name: "web_crawl",
    category: "web-media",
  ...
  },
  {
    ...
    readOnly: false,
    caideMapping: "caide-native",
    caideTool: "dyad/web (Pollinations default, keyed override M3)",
  },
  // plan-memory
  {
    name: "update_todos",
  ...
  },
  {
    ...
    readOnly: true,
    caideMapping: "caide-native",
    caideTool: "dyad/sandbox (runner wired in M3)",
  },
  // mcp
  {
  ...
  // sandbox
  {
    ...
    readOnly: false,
    caideMapping: "caide-native",
    caideTool: "dyad/sandbox (read/write/MCP hosts + worker)",
  },
...
export function getToolMeta(name: string): ToolMeta | undefined {
  return (
    TOOL_CATALOG.find((t) => t.name === name) ?? TOOL_CATALOG.find((t) => t.caideTool === name)
  );
}
