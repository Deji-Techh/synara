// FILE: bm25.ts
// Purpose: BM25 ranking for MCP tool search (keyword → top signatures,
// keeping context lean).
// Donor: dyad x caide tools/bm25.ts (verbatim ranking logic; McpToolDef
// imported from ./mcpTools.ts instead of the AI-SDK-coupled original).

import type { McpToolDef } from "./mcpTools.ts";
