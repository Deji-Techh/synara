// FILE: mcpConsentPolicy.ts
// Purpose: System prompt for the MCP auto-consent classifier (cheap model):
// allow vs ask for third-party MCP tool calls.
// Donor: dyad x caide src/prompts/mcp_consent_policy.ts (verbatim —
// SCAFFOLD role/format/trust + POLICY allow/ask criteria + composer).
