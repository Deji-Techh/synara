// FILE: securityReviewPrompt.ts
// Purpose: Security-review pass prompt (verbatim donor text).
// Donor: dyad src/prompts/security_review_prompt.ts (verbatim —
// SECURITY_REVIEW_SYSTEM_PROMPT body byte-identical; only this header added).
