// FILE: supabasePrompt.ts
// Purpose: Supabase prompt rules + available/disconnected/not-available
// builders (verbatim donor text).
// Donor: dyad src/prompts/supabase_prompt.ts (verbatim — bodies
// byte-identical; only this header added; Apache-2.0 attribution below kept).
