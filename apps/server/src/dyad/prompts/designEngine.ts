// FILE: designEngine.ts
// Purpose: Superior-design directive + design-first generation contract +
// design-reference index for generated apps.
// Donor: dyad x caide src/prompts/design_engine_contract.ts and
// src/prompts/design_reference_index.ts (verbatim).
