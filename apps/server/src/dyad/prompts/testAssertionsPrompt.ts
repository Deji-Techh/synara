// FILE: testAssertionsPrompt.ts
// Purpose: Assertion code-synthesis pass prompt + payload builder (verbatim
// donor text). Consumed by the future `generate_test_assertions` tool port;
// landed now so the prompt layer is complete.
// Donor: dyad src/prompts/test_assertions_prompt.ts (verbatim — bodies
// byte-identical; only this header added).
