// FILE: summarizeChatPrompt.ts
// Purpose: Chat-title summarizer prompt (verbatim donor text).
// Donor: dyad src/prompts/summarize_chat_system_prompt.ts (verbatim —
// SUMMARIZE_CHAT_SYSTEM_PROMPT body byte-identical; only this header added).
