// FILE: projectPackageArchive.ts
// Purpose: CAIDEPKG archive format (gzip JSONL records + chunked files,
// checksums, path-escape guards, size limits).
// Donor-verbatim: dyad x caide src/ipc/services/project_package_archive.ts
// (pure node — no adaptation needed).
