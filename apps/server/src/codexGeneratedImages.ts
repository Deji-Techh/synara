...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@caide/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Caide uses its isolated
 ...
 * overlay `<CAIDE_HOME>/codex-home-overlay/generated_images` so we serve
