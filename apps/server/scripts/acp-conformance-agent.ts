...
const logPath = process.env.CAIDE_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.CAIDE_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "caide-official-sdk-conformance-agent" })
