#!/bin/bash
# Compiles caide-device-helper with the user's own Xcode toolchain.
#
...
#   CAIDE_DEVICE_HELPER_OUT=/path build.sh
#
...
OUT_DIR="${1:-${CAIDE_DEVICE_HELPER_OUT:-$SOURCE_DIR/build}}"
BINARY_NAME="caide-device-helper"
