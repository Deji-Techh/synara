...
typedef NS_ENUM(NSInteger, CaideHardwareButton) {
  CaideHardwareButtonHome,
  CaideHardwareButtonLock,
  CaideHardwareButtonSide,
  CaideHardwareButtonSiri,
  CaideHardwareButtonVolumeUp,
  CaideHardwareButtonVolumeDown,
};
...
@interface CaideHIDBridge : NSObject
...
- (void)tapButton:(CaideHardwareButton)button NS_SWIFT_NAME(tapButton(_:));
