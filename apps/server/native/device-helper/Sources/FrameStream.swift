...
final class FrameSocketWriter {
  ...
  private let queue = DispatchQueue(label: "dev.caide.device-helper.socket")
...
final class FrameStream {
  ...
  private let encodeQueue = DispatchQueue(label: "dev.caide.device-helper.encode")
