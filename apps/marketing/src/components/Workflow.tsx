...
export default function Workflow() {
  return (
    <section id="workflow" className="scroll-mt-20 border-t border-[var(--divide)] py-14 sm:py-20">
      <div className={container}>
        ...
        <p className={body}>
          ...
          explicit architectural alignment, transparent execution gates, instant database branching,
          and live multi-device preview.
        </p>
