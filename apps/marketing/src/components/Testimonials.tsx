      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.id}
              className="flex flex-col justify-between rounded-2xl border border-[var(--divide)] bg-[var(--card)] p-6 shadow-sm transition-all hover:border-[var(--border-strong)]"
            >
              <div>
                <div className="mb-3 text-[12px] font-semibold text-orange-600 dark:text-orange-400">
                  {t.highlight}
                </div>
