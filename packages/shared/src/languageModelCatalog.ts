  ...
  groq: [
    {
      ...
      description: "Open-weights 120B model on Groq LPUs",
      contextWindow: 128_000,
    ...
    },
    {
      ...
      description: "Fast open-weights 20B model on Groq LPUs",
      contextWindow: 128_000,
      maxOutputTokens: 16_384,
      temperature: 0.7,
      dollarSigns: 1,
    },
    {
      ...
      description: "Qwen 3.8 generation 27B on Groq LPUs",
      contextWindow: 128_000,
      maxOutputTokens: 16_384,
      temperature: 0.7,
      dollarSigns: 1,
    },
    {
      ...
      description: "Groq's compound reasoning model",
      contextWindow: 128_000,
    ...
    },
    {
      ...
      description: "Groq's compact compound model for fast tasks",
      contextWindow: 128_000,
      maxOutputTokens: 16_384,
      temperature: 0.7,
      dollarSigns: 1,
