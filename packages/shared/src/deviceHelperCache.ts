 ...
 *
 * This lives in `@caide/shared` because two independent callers derive the
...
/** `~/Library/Caches/caide/device-helper` — callers pass their own home dir. */
...
export const DEVICE_HELPER_BINARY_NAME = "caide-device-helper";

/** Physical helper source directory passed from packaged desktop to its backend child. */
export const DEVICE_HELPER_SOURCE_DIR_ENV = "CAIDE_DEVICE_HELPER_SOURCE_DIR";
