...
export const WS_METHODS = {
  ...
  serverRunToolchainDoctor: "server.runToolchainDoctor",
  ...
  providerCreateCustomSkill: "provider.createCustomSkill",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.serverRunToolchainDoctor, ServerRunToolchainDoctorInput),
  ...
  tagRequestBody(WS_METHODS.providerCreateCustomSkill, ProviderCreateCustomSkillInput),
