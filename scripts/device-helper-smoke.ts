...
import { decodeDeviceFrame } from "@caide/shared/deviceFrame";
import {
...
async function main(): Promise<void> {
  ...
  // comes from @caide/shared so this build lands in the same directory the
  ...
  try {
    ...
    const socketDir = mkdtempSync(join(tmpdir(), "caide-device-smoke-"));
