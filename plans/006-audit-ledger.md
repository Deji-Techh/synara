...
AppImage sealed 21:03 (`release/Caide-0.0.1-x86_64.AppImage`, 342MB, git-ignored): workspace build 5/5 → dist verified to contain the transplant (HarnessHub, provider_settings_state, route layer) → packaged. Boot smoke + live socket smoke green before sealing. 
