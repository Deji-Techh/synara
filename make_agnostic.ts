...
content = content.replace(/\\`multi_replace_file_content\\`/g, "your multi-region file editing tool");
content = content.replace(/`grep_search`/g, "your code search tool");

content = content.replace(/Use your precise file editing tool for edits/g, "Use your available file editing tools for edits");
